...
function Introduction(){
    return(
        ...
        I'm a dedicated professional with more than a year of experience ( <span className="blue fw-bold">1 year 3 months</span> ) in manual testing. I have knowledge in <span className="blue fw-bold">Java</span> and <span className="blue fw-bold">Selenium.</span> I'm an enthusiastic learner who can quickly grasp upcoming Technologies and learned <span className="blue fw-bold">MERN </span> (<span className="blue fw-bold">Mongo DB, Express JS, React JS, Node JS</span>) stack to become a full stack developer out of own interest and has done a certification course on it.
        </p>
        <p className="fs-6 text-start pb-1">
